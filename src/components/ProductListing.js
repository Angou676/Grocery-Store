        ...
        <Tab {...getIndexValue(0)} 
           component={() => (
            <GroceryTabBlock onClick={()=>{
             ...
             <GroceryTabButton>
                <img className="cateSlectimageBlock" src='https://www.freepnglogos.com/uploads/vegetables-png/air-cargo-agent-mangalore-fresh-vegetables-fruits-27.png'  />
                </GroceryTabButton> 
          ...
          component={() => (
            ...
            <GroceryTabButton>
                    <img className="cateSlectimageBlock" src='https://www.freepngimg.com/thumb/potato/7-potato-png-images-pictures-download-thumb.png' width="100" height="80" />
               </GroceryTabButton> 
          ...
          <Tab  {...getIndexValue(2)} 
           component={() => (
            <GroceryTabBlock onClick={()=>{
               ...
               <GroceryTabButton>
               <img className="cateSlectimageBlock" src='https://toppng.com/uploads/preview/apple-fruit-11526067113bpkdzjmq8g.png' width="100" height="80" />
               </GroceryTabButton> 
          ...
          <Tab  {...getIndexValue(3)} 
           component={() => (
            <GroceryTabBlock onClick={()=>{
                ...
                <GroceryTabButton>
                <img className="cateSlectimageBlock" src='https://mangobazaar.in/image/cache/catalog/Exotic%20vegetables/chinese%20cabbage-600x600.png' width="100" height="80" />
               </GroceryTabButton> 
         ...
         <Tab  {...getIndexValue(4)} 
           component={() => (
            <GroceryTabBlock onClick={()=>{
             ...
             <GroceryTabButton>
                <img className="cateSlectimageBlock" src='https://www.dlf.pt/dfpng/middlepng/117-1174168_broccoli-organic-food-cauliflower-vegetable-broccoli-png-transparent.png' width="100" height="80" />
               </GroceryTabButton> 
          ...
          <Tab {...getIndexValue(5)} 
           component={() => (
            ...
            <GroceryTabButton>
            <img className="cateSlectimageBlock" src='https://pngimg.com/uploads/mango/mango_PNG9163.png' width="100" height="80" />
               </GroceryTabButton> 
          ...
          <Tab  {...getIndexValue(6)} 
           component={() => (
            ...
            <GroceryTabButton>
            <img className="cateSlectimageBlock" src='https://w7.pngwing.com/pngs/609/33/png-transparent-calabash-gourd-cucurbitaceae-vegetable-bitter-melon-vegetable-wish-food-gourd-thumbnail.png' width="100" height="80" />
               </GroceryTabButton> 
          ...
          <Tab {...getIndexValue(7)} 
           component={() => (
            <GroceryTabBlock onClick={()=>{
             ...
             <GroceryTabButton>
             <img className="cateSlectimageBlock" src='https://w7.pngwing.com/pngs/532/449/png-transparent-cruciferous-vegetables-cabbage-vegetarian-cuisine-cabbage-cut-material-leaf-vegetable-food-cooking.png' width="100" height="80" />
               </GroceryTabButton> 
                    ...
                    <Item >
                        <GroceryCardBlock >
                            ...
                            <PriceButtonBlock>
                                ...
                                <ButtonBlock>
                                    <Button variant="outlined" className='buttonBlock' >add</Button>
                                </ButtonBlock>
                            </PriceButtonBlock>
                        </GroceryCardBlock>
                    </Item>                   
